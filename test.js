...
if ((hasUpperCase + hasLowerCase + hasNumbers + hasSpecialChars) < 4) { // Enforced minimum character types
    console.error("Password must include a mix of at least four character types.");
    return;
}
