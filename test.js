...
if (!password) {
    ...
    bcrypt.hash(password, saltRounds, function(err, hashedPassword) {
        if (err) {
            ...
            return; // Changed to return instead of exiting the process
        }
...
function comparePasswords(inputPassword) {
    return constantTimeCompare(inputPassword, password);
}
...
// Securely handle password storage
let storedHashedPassword = password; // Store hashed password securely
