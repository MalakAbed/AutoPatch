...
if ((hasUpperCase + hasLowerCase + hasNumbers + hasSpecialChars) < 3) { // Enforced minimum character types
    console.error("Password must include a mix of at least three character types.");
    return;
}
