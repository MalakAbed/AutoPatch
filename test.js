...
if (isNaN(saltRounds) || saltRounds < 14 || saltRounds > 31) {
    console.error("Invalid SALT_ROUNDS value. Using default of 14.");
    saltRounds = 14; // Increased default to 14 for better security
}
...
// Ensure securePassword is cleared properly
securePassword = null;
